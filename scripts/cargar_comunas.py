...
from database.modelos import Comuna

if "--confirmar" not in sys.argv:
    print("Este script borra y recarga todas las comunas.")
    print("Ejecuta: python scripts/cargar_comunas.py --confirmar")
    raise SystemExit(1)

db = SessionLocal()
db.query(Comuna).delete()
...
comunas_por_region = {
    ...
    "Región V de Valparaíso": [
        ...
        "Concón", "El Quisco", "El Tabo", "Hijuelas", "Isla de Pascua",
        "Juan Fernández", "La Calera", "La Cruz", "La Ligua", "Limache",
    ...
    "Región Metropolitana de Santiago": [
        ...
        "La Granja", "Lampa", "La Pintana", "La Reina", "Las Condes",
    ...
    "Región VI del Libertador Gral. Bernardo O'Higgins": [
        ...
        "Requínoa", "San Fernando", "Santa Cruz", "San Vicente"
    ],
    "Región VII del Maule": [
        ...
        "San Javier", "San Rafael", "Talca", "Teno", "Vichuquén",
    ...
    "Región XIV de Los Ríos": [
        "Corral", "Futrono", "Lago Ranco", "Lanco", "La Unión", "Los Lagos",
    ...
    "Región XI Aysén del G. Carlos Ibáñez del Campo": [
    ...
    "Región XII Magallanes y de la Antártica Chilena": [
        ...
        "Primavera", "Punta Arenas", "Río Verde", "San Gregorio",
        "Timaukel", "Torres del Paine"
    ],
}

total = 0
for region, lista_comunas in comunas_por_region.items():
    for nombre in lista_comunas:
        db.add(Comuna(c_nombre=nombre, c_region=region))
        total += 1

db.commit()
db.close()

print(f"Comunas cargadas correctamente: {total}")
